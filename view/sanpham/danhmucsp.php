<?php
         ...
         $bd = ($page-1)*4;
         $kt = $bd + 4;
         $sql = "select * from san_pham where ma_dm = $id limit $bd,$kt";
         $sp = pdo_query($sql);

?>
<hr>
<div class="titles">Trang chủ/ <?php echo $dm['ten_dm'] ?>
    </div >
<section class="cont">
  <div class="loc">
  ...
  <section class="titles">
   ...
   <a href="index.php?act=dmsp&id=<?php echo $id?>&page=<?php echo $i?>" class="<?php if($i == $page) echo "active"?>"><?php echo $i?></a>
   <?php endfor ?>
   </div>
   </div>
