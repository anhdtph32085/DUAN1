...
?>
<hr>
<div class="titles">Trang chủ/ Tìm kiếm 
    </div >
<section class="cont">
<div class="loc">
  ...
  <section class="titles">
        <h2>Kết quả tìm kiếm với từ khóa '<i><?php if(isset($_SESSION['key'])) echo $_SESSION['key'] ?></i>' :</h2>
      </section>
      <div class="products">
   ...
   <a href="index.php?act=timkiem&page=<?php echo $i?>" class="<?php if($i == $page) echo "active"?>"><?php echo $i?></a>
   <?php endfor ?>
   </div>
   </div>
